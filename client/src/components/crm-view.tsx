                    ...
                    <div className="grid grid-cols-6 gap-1 pt-2 border-t bg-gray-50 p-2 rounded-b-lg">
                      ...
                      {contact.email ? (
                        <Button 
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            window.location.href = `mailto:${contact.email}?subject=Follow up from Traffik Boosters&body=Hi ${contact.firstName},%0D%0A%0D%0AThank you for your interest in our digital marketing services. I wanted to follow up and see if you have any questions about how we can help grow your business.%0D%0A%0D%0ABest regards,%0D%0ATraflik Boosters%0D%0A(877) 840-6250`;
                            toast({
