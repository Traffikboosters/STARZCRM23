...
// Email configuration for hosting account
// Update these settings with your hosting provider's email settings
const emailConfig = {
  host: 'smtp.ipage.com', // Your hosting SMTP server
  port: 465, // Usually 465 for SSL or 587 for TLS
  secure: true, // true for 465, false for other ports
  auth: {
    user: 'starz@traffikboosters.com', // Your hosting email
    pass: process.env.HOSTING_EMAIL_PASSWORD || 'your-email-password' // Your email password
  }
};
...
async function sendWordPressPlugin() {
  try {
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="feature-box">
                ...
                <ul>
                    <li><strong>starz-chat-widget.php</strong> - Complete WordPress plugin</li>
    ...
    console.log(`📬 Email sent to: traffikboosters@gmail.com`);
    console.log('📎 Attachments included:');
    console.log('   - starz-chat-widget.php (WordPress Plugin)');
    console.log('   - STARZ-Chat-Widget-Installation-Guide.md (Instructions)');
    ...
    if (error.code === 'EAUTH') {
      ...
      console.log('   - Email username: starz@traffikboosters.com');
      console.log('   - Email password is correct');
      console.log('   - SMTP settings match your hosting provider');
    } else if (error.code === 'ECONNECTION') {
      console.log('💡 Connection failed. Please check:');
      console.log('   - SMTP server: smtp.ipage.com');
...
// Alternative method using different hosting providers
function getHostingEmailConfigs() {
  return {
    ipage: {
      host: 'smtp.ipage.com',
      port: 465,
  ...
  sendWordPressPlugin()
    .then(result => {
      if (result.success) {
        ...
        console.log('💡 You can manually download the files from this directory:');
...
module.exports = { sendWordPressPlugin, getHostingEmailConfigs };