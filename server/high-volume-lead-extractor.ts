...
export class HighVolumeLeadExtractor {
  private extractionTargets: LeadExtractionTarget[] = [
    ...
    {
      id: 'bark_com',
      name: 'Bark.com Business Providers',
      baseUrl: 'https://www.bark.com',
      dailyLimit: 100,
      currentDaily: 0,
      extractionMethod: 'scraping',
      searchCategories: ['home-improvement-businesses', 'professional-service-providers', 'tutoring-businesses', 'event-service-companies', 'wellness-providers', 'automotive-services', 'pet-service-businesses'],
      regions: ['nationwide'],
      isActive: true,
      lastExtraction: new Date(),
      successRate: 92
