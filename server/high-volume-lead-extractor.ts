  ...
  private extractionTargets: LeadExtractionTarget[] = [
    {
      ...
      searchCategories: ['local-seo-prospects', 'gmb-optimization-candidates', 'maps-ranking-opportunities', 'local-visibility-needs'],
    ...
    {
      id: 'yellow_pages',
      name: 'Yellow Pages Directory Businesses',
      baseUrl: 'https://www.yellowpages.com',
      dailyLimit: 100,
      currentDaily: 0,
      extractionMethod: 'scraping',
      searchCategories: ['basic-listing-upgrade-prospects', 'traditional-businesses-needing-digital-presence', 'directory-to-website-conversion-opportunities'],
    ...
    {
      id: 'bark_com',
      name: 'Bark.com Premium Marketing Prospects',
      baseUrl: 'https://www.bark.com',
      dailyLimit: 100,
      currentDaily: 0,
      extractionMethod: 'scraping',
      searchCategories: ['lead-generation-upsell-opportunities', 'marketing-budget-holders', 'conversion-optimization-prospects', 'premium-service-providers'],
      regions: ['nationwide'],
      isActive: true,
      lastExtraction: new Date(),
      successRate: 92
    ...
    {
      id: 'zoominfo',
      name: 'ZoomInfo Enterprise B2B',
      baseUrl: 'https://api.zoominfo.com',
      dailyLimit: 100,
      currentDaily: 0,
      extractionMethod: 'api',
      searchCategories: ['enterprise-digital-transformation', 'b2b-marketing-automation', 'corporate-web-development', 'enterprise-seo-services'],
