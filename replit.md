...
- July 6, 2025. LEAD CARD EDIT BUTTON RENAMED TO DETAIL: Successfully updated all lead card "Edit" buttons to "DETAIL" across both main CRM view and simple CRM view components. Changed button text and icon from Calendar to User for better visual consistency with contact details functionality.
